 ...
 * AI Agent Utility
 *
 * Easy-to-use wrapper for calling the Lyzr AI Agent API
 * Pre-configured with API key on backend - just send your message and agent_id!
 *
 * @example
 * ```tsx
...
/**
 * Call the AI Agent with a message and agent_id (DIRECT LYZR API CALL)
 *
